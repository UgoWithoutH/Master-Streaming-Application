...
namespace TestWatchlist
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            w.AjouterOeuvre(new Serie("Harry", new DateTime(1999, 01, 15), "C'est cool", null, "/images/Drame/Notre ete.jpg", 52, new HashSet<Genre>() { new Genre("Action"), new Genre("Drame") }));

            foreach(Oeuvre o in w.OeuvresVisionnees)
            {
                Console.WriteLine(o);
            }
        }
